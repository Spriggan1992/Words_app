...
//       if (providerData.listBricks.isEmpty) {
...
//       shuffledWordArray.listBricks.shuffle();
//     } else {
//       print('Data is Empty');
//     }
//   }
...
//                   initialData.clear();
//                   Provider.of<Bricks>(context, listen: false).cleanData();
//                 },
//                 child: Text("YES"),
//               ),
//             ],
...
//             providerData.listBricks[i].isVisible = true;
...
//     for (int i = 0; i < shuffledWordArray.listBricks.length; i++) {
//       if (element == shuffledWordArray.listBricks[i].targetLangWord &&
//           shuffledWordArray.listBricks[i].isVisible == false) {
//         shuffledWordArray.listBricks[i].isVisible = true;
//         break;
//       }
//       setState(() {});
//     }
...
//     if (answerWordArray.length != shuffledWordArray.listBricks.length) {
//       return false;
//     }
//     return true;
//   }
...
//           onTap: () {
//             setState(() {});
//             addLetter(shuffledWordArray.listBricks[i].targetLangWord);
//             shuffledWordArray.listBricks[i].toggleVisibility();
//           },
//           child: shuffledWordArray.listBricks[i].isVisible
//               ? Container(
//                   decoration: BoxDecoration(
...
//                   height: 45,
//                   child: Text(
//                     shuffledWordArray.listBricks[i].targetLangWord,
//                     style: TextStyle(fontSize: 20),
//                   ),
//                 )
